      ...
      child: Column(
        ...
        children: [
          Padding(
            ...
            child: Row(children: [
              const CircleAvatar(radius: 14, backgroundColor: AppColors.appSurface, child: Icon(FontAwesomeIcons.user, size: 12, color: Colors.white24)),
...
Widget badge(String t, Color bg, Color tc) => Container(padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 4), color: bg, child: Text(t, style: TextStyle(color: tc, fontSize: 9, fontWeight: FontWeight.bold)));